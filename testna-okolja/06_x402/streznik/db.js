...
/**
 * SQLite persistence layer — MERGED one-time payment flow (folder
 * 06_x402). Identical schema to folder 01 (payment_requests,
 * payment_proofs, redeemed_tx_hashes, openai_usage) — the merged 4-message
 * protocol changes WHERE verification happens, not what is stored.
 *
...
const DB_PATH = process.env.DB_PATH || path.join(DATA_DIR, 'x402_zdruzena.db');
